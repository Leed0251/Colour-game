...
class ChooseRounds:
    ...
    def __init__(self):
        ...
        self.ten_button = Button(self.how_many_frame,
            ...
            command=lambda: self.to_play(10)
        )
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        self.instructions_label = Label(self.quest_frame,
            text=instructions,
            wraplength=350,
            justify="left"
        )
        ...
        for item in range(0, 6):
            self.choice_button = Button(self.choice_frame,
                ...
                bg=self.button_colours_list[item][0],
                text=f"{self.button_colours_list[item][0]}",
                width=15,
        ...
        self.round_results_label = Label(self.rounds_frame,
            text="Round 1: User: 0\tComputer: -",
            width=32,
            bg="#FFF2CC",
            font=("Arial", "10"),
            pady=5
        ...
        self.next_button = Button(self.rounds_frame,
            text="Next Round",
            fg="#FFFFFF",
            bg="#008BFC",
            font=("Arial", 11, "bold"),
